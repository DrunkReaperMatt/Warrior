...
UWarriorAbilitySystemComponent* UWarriorGameplayAbility::GetWarriorAbilitySystemFromActorInfo() const
{
	...
	const FGameplayEffectSpecHandle& InSpecHandle)
{
	...
	return GetWarriorAbilitySystemFromActorInfo()->ApplyGameplayEffectSpecToTarget(
		*InSpecHandle.Data,
		TargetASC);
